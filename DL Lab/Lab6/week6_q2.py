...
batch_size = 1  # You can adjust this based on available GPU memory
...
# Modify the classifier layer for binary classification (2 output classes)
model.classifier[6] = nn.Linear(4096, 2)  # Replace the final fully connected layer
